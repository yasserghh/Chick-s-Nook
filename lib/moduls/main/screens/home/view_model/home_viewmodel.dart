...
const mp.LatLng(36.716727492805816, 2.8275594683729537),
   ...
   final babezawarePolygon = <mp.LatLng>[
    const mp.LatLng(36.7554271, 2.9514455),
    const mp.LatLng(36.7628863, 2.9362901),
    const mp.LatLng(36.7542472, 2.9354679),
    const mp.LatLng(36.7554271, 2.9514455), // closing the polygon (optional)
  ];
